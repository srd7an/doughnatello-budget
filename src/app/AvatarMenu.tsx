  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="grid size-11 sm:size-8 place-items-center rounded-full bg-stone-300 text-sm font-medium text-stone-800 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand"
      >
