      ...
      <div className="space-y-5">
        ...
        {adding ? (
          ...
          <button
            ...
            className="flex min-h-9 items-center gap-1 rounded-full px-2 py-1.5 text-sm font-medium text-brand hover:bg-violet-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand"
          >
